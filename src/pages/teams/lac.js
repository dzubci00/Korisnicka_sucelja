    ...
    clear:"both",
            ...
            <div sx={{
                ...
                <div sx={{top: "85px",
                        ...
                        height:"300px",
                        backgroundImage:"url(https://www.nba.com/assets/logos/teams/primary/web/LAC.svg)",
                        backgroundSize:"100%",
                        }}>
                ...
                <div sx={{backgroundColor:"#C8102E", height:"55px", borderBottom:"1px solid grey", borderTop:"1px solid grey"}}>
                </div>
                <p
        style={{
          fontFamily: "body",
      ...
      >
         ...
         <span sx={{fontWeight:"900", fontSize:"25px"}}>The Los Angeles Clippers</span> (branded as the LA Clippers) are an American professional basketball team based in Los Angeles. The Clippers compete in the National Basketball Association (NBA) as a member of the Pacific Division in the league's Western Conference. The Clippers play their home games at the Staples Center, an arena they share with fellow NBA team the Los Angeles Lakers, as well as the Los Angeles Sparks of the Women's National Basketball Association (WNBA), and the Los Angeles Kings of the National Hockey League (NHL).
