    ...
    clear:"both",
            ...
            <div sx={{
                ...
                <div sx={{top: "85px",
                        ...
                        height:"300px",
                        backgroundImage:"url(https://www.nba.com/assets/logos/teams/primary/web/OKC.svg)",
                        backgroundSize:"100%",
                        }}>
                ...
                <p sx={{marginLeft:"200px",marginBottom:"0",fontSize:"35px", fontWeight: "500",}}>Oklahoma City</p>
                <p sx={{marginBottom:"35px",marginLeft:"200px",marginTop:"0", fontSize:"55px", fontWeight:"700"}}>Thunder</p>

                </div>
                </div>


                <div sx={{backgroundColor:"#007AC1", height:"55px", borderBottom:"1px solid grey", borderTop:"1px solid grey"}}>
                </div>
                <p
        style={{
          fontFamily: "body",
      ...
      >
         ...
         <span sx={{fontWeight:"900", fontSize:"25px"}}>The Oklahoma City Thunder </span>are an American professional basketball team based in Oklahoma City. The Thunder compete in the National Basketball Association (NBA) as a member of the league's Western Conference Northwest Division.[8][9] The team plays its home games at Chesapeake Energy Arena.[10]
