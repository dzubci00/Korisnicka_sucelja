    ...
    clear:"both",
            ...
            <div sx={{
                ...
                <div sx={{top: "85px",
                        ...
                        height:"300px",
                        backgroundImage:"url(https://www.nba.com/assets/logos/teams/primary/web/ORL.svg)",
                        backgroundSize:"100%",
                        }}>
                ...
                <p sx={{marginLeft:"200px",marginBottom:"0",fontSize:"35px", fontWeight: "500",}}>Orlando</p>
                <p sx={{marginBottom:"35px",marginLeft:"200px",marginTop:"0", fontSize:"55px", fontWeight:"700"}}>Magic</p>

                </div>
                </div>


                <div sx={{backgroundColor:"#0077C0", height:"55px", borderBottom:"1px solid grey", borderTop:"1px solid grey"}}>
                </div>
                <p
        style={{
          fontFamily: "body",
