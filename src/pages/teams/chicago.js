    ...
    clear:"both",
            ...
            <div sx={{
                ...
                <div sx={{top: "85px",
                        ...
                        height:"300px",
                        backgroundImage:"url(https://www.nba.com/assets/logos/teams/primary/web/CHI.svg)",
                        backgroundSize:"100%",
                        }}>
                ...
                <p sx={{marginLeft:"200px",marginBottom:"0",fontSize:"35px", fontWeight: "500",}}>Chicago</p>
                <p sx={{marginBottom:"35px",marginLeft:"200px",marginTop:"0", fontSize:"55px", fontWeight:"700"}}>Bulls</p>
      ...
      >
         ...
         <span sx={{fontWeight:"900", fontSize:"25px"}}>The Chicago Bulls</span> are an American professional basketball team based in Chicago. The Bulls compete in the National Basketball Association (NBA) as a member of the league's Eastern Conference Central Division.[9] The team was founded on January 16, 1966 and played its first game during the 1966–67 NBA season.[1] The Bulls play their home games at the United Center, an arena on Chicago's West Side shared with the Chicago Blackhawks of the National Hockey League (NHL).
