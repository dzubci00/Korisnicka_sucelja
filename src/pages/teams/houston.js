    ...
    clear:"both",
            ...
            <div sx={{
                ...
                <div sx={{top: "85px",
                        ...
                        height:"300px",
                        backgroundImage:"url(https://www.nba.com/assets/logos/teams/primary/web/HOU.svg)",
                        backgroundSize:"100%",
                        }}>
                ...
                <p sx={{marginLeft:"200px",marginBottom:"0",fontSize:"35px", fontWeight: "500",}}>Houston</p>
                <p sx={{marginBottom:"35px",marginLeft:"200px",marginTop:"0", fontSize:"55px", fontWeight:"700"}}>Rockets</p>
      ...
      >
         ...
         <span sx={{fontWeight:"900", fontSize:"25px"}}>The Houston Rockets</span> are an American professional basketball team based in Houston. The Rockets compete in the National Basketball Association (NBA) as a member team of the league's Western Conference Southwest Division. The team plays its home games at the Toyota Center, located in Downtown Houston. Throughout its history, Houston has won two NBA championships and four Western Conference titles. It was established in 1967 as the San Diego Rockets, an expansion team originally based in San Diego. In 1971, the Rockets relocated to Houston.
